...
//b1.v.add(new PVector((b2.pos.x - b1.pos.x)/250 - b1.v.x, (b2.pos.y - b1.pos.y)/250 - b1.v.y));
//b2.v.add(new PVector((b1.pos.x - b2.pos.x)/250 - b2.v.x, (b1.pos.y - b2.pos.y)/250 - b2.v.y));
...
//  v.x = v.x*xoin;
//  vy = vy;
v.add(new PVector((oin.pos.x - pos.x)/250 - v.x, (oin.pos.y - pos.y)/250 - v.y));
  }
